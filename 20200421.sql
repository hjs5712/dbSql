 ...
 SELECT *
 FROM emp
 WHERE LOWER(ename) = 'smith'; 이런식으로 작정하면 안된다
 ...
 SYBSTR(문자열, 시작인덱스, 종료 인덱스) : 문자열의 시작인덱스 부터....종료인덱스 까지의 부분 문자열
 ...
 FROM dual;
  ...
  date type +- 정수 : 일자 더하기 빼기
   ...
   숫자 : ....
   문자 : ''
   날짜 : TO_DATE("날짜 문자열", '포멧')
  
  SELECT SYSDATE, SYSDATE + 5
  FROM dual;
 
 fn1]
 SELECT TO_DATE('20101231', 'YYYYMMDD') lastday, TO_DATE('20101231', 'YYYYMMDD')-5 lastday_before5, 
